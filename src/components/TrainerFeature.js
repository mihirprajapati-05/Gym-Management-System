    ...
    <div className='mt-5 bg-black'>
      <div className="card pmd-card bg-dark text-white text-center overlay-card">
        ...
        <div className="card-img-overlay bg-black">
          <h2 className="card-title" style={{fontSize:'40px',marginTop:'50px',marginBottom:'100px'}}>Trainer Dashboard</h2>
          <div class="card-deck">
